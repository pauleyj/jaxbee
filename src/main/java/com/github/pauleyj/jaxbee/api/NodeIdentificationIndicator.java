...
public class NodeIdentificationIndicator extends RxFrame<NodeIdentificationIndicator> {
    ...
    public String toString() {
        ...
        return new StringBuffer()
            ...
            .append("\"receive_options\" : ").append(String.format("0x%02x", receiveOptions)).append(", ")
            .append("\"tx_source_address_16\" : ").append(String.format("0x%02x", transmitterSourceAddress16)).append(", ")
            .append("\"tx_source_address_64\" : ").append(String.format("0x%08x", transmitterSourceAddress64)).append(", ")
            .append("\"node_identifier\" : ").append('"').append(new String(getNodeIdentifier())).append('"').append(", ")
            .append("\"parent_address_16\" : ").append(String.format("0x%02x", parentAddress16)).append(", ")
            .append("\"device_type\" : ").append('"').append(getDeviceType()).append('"').append(", ")
            .append("\"source_event\" : ").append('"').append(getSourceEvent()).append('"').append(", ")
            .append("\"profile_id\" : ").append('[').append(String.format("0x%02x, 0x%02x", profileId[0], profileId[1])).append(']').append(", ")
            .append("\"manufacture_id\" : ").append('[').append(String.format("0x%02x, 0x%02x", manufactureId[0], manufactureId[1])).append(']')
            .append('}')
            .toString();
    }
}
